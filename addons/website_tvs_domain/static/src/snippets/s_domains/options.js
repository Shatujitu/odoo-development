odoo.define('website_tvs_domain.s_domains_options', function (require) {
    'use strict';
    ...
    const dynamicSnippetDomainsOptions = dynamicSnippetOptions.extend({
        /**
         *
         * @override
         */
        ...
        onBuilt() {
            ...
            this.$target[0].dataset['snippet'] = 's_domains';
        },
    ...
    options.registry.dynamic_snippet_domains = dynamicSnippetDomainsOptions;

    return dynamicSnippetDomainsOptions;
});
