odoo.define('website_tvs_domain.s_sub_domains_options', function (require) {
    'use strict';
    ...
    const dynamicSnippetSubDomainsOptions = dynamicSnippetOptions.extend({
        /**
         *
         * @override
         */
        init: function () {
            ...
            this.modelNameFilter = 'tvs.domain';
            this.domains = {};
        },
        /**
         * @override
        ...
        onBuilt() {
            ...
            this.$target[0].dataset['snippet'] = 's_sub_domains';
        },
        ...
        _fetchDomains: function () {
            return this._rpc({
                ...
                kwargs: {
                    ...
                    domain: [
                        ['sub_domain_ids', '!=', false], // Add a filter to fetch domains where sub_domain_ids is not null
                    ],
                    fields: ['id', 'name'],
                }
            });
    ...
    options.registry.dynamic_snippet_sub_domains = dynamicSnippetSubDomainsOptions;

    return dynamicSnippetSubDomainsOptions;
});
